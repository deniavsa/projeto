...
class PesquisaEquipamento extends Component {
    constructor(props) {
        super(props);
        this.state = {
            equipamento: [],
                    ...
                    <header class="fixed">
                        <div id="menu_header_lateral_esquerda_adm">
                            ...
                            <div id="campo_busca_header_adm">
                                ...
                                <form action="">
                                    <input type="text" value="" placeholder="Buscar equipamento" onChange={this.filterList} />
                                </form>
                            </div>
                        </div>
...
export default PesquisaEquipamento;